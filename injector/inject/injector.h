...
/////////////////////////////////
void Kernel_Injector(LPCSTR windowname, BYTE* dll_path)
{
	Sleep(100);
	// get dll file
	PVOID dll_image = dll_path;
	if (!dll_image)
	{
#ifdef DEBUG_PRINT
	...
	DWORD process_id;
	DWORD thread_id = GetWindowThreadProcessId(FindWindow(NULL, xor_a("Call of Duty® HQ")), &process_id);
#ifdef DEBUG_PRINT
